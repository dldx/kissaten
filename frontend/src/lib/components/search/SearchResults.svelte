<script lang="ts">
  ...
  function handleAddRoasterLocationDefaults() {
    roasterLocationFilter = [...userDefaults.roasterLocations];
    onSearch();
  }
...
<main class="flex-1">
  ...
  <div class="mb-6">
    <FilterTags
      ...
      {originOptions}
      {roasterLocationOptions}
      defaultRoasterLocations={userDefaults.roasterLocations || []}
      onRemoveFilter={handleRemoveFilter}
      onClearAll={onClearFilters}
      onAddRoasterLocationDefaults={handleAddRoasterLocationDefaults}
    />
  </div>
