        ...
        magicLink({
            sendMagicLink: async ({ email, token, url }, request) => {
                ...
                await sendEmail({
					...
					text: `Click the link to sign in: ${url.toString()}`,
					html: `
						<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
							<h2>Sign in to Kissaten</h2>
							<p>Click the button below to sign in to your account:</p>
							<a href="${url.toString()}" style="display: inline-block; padding: 12px 24px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 4px; margin: 20px 0;">Sign In</a>
							<p>Or copy and paste this link into your browser:</p>
							<p style="word-break: break-all; color: #666;">${url.toString()}</p>
