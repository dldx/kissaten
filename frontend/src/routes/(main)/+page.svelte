	...
	onMount(() => {
		...
		const animateCounters = async () => {
			...
			try {
				...
				console.error(
					"Failed to load real stats for counter animation:",
					e,
				);
			}
...
>
	...
	>
		...
		<div
			...
			style="transform: translateZ(-80px) rotateY({heroRotateY *
				0.2}deg);"
		>
			{@html HeroSteamWisps}
		</div>
	...
	<div class="-top-5 z-10 relative mx-auto px-6 container">
		...
		>
			...
			>
				Discover extraordinary coffee beans from passionate roasters
				worldwide
			</p>
	...
	>
		...
		>
			<ArrowDown
				class="mt-3 w-4 h-4 text-slate-400 dark:text-slate-600"
			/>
		</button>
	</div>
</section>
...
>
	...
	>
		...
		>
			...
			<p
				class="mx-auto max-w-2xl text-slate-600 dark:text-slate-300 text-xl"
			>
				We're building the world's most comprehensive coffee bean
				database
			</p>
		</div>
			...
			<div class="gap-8 grid md:grid-cols-2 lg:grid-cols-4 mb-16">
				...
				>
					...
					>
						{@html StatsBean}
						<div
							class="font-bold text-green-700 dark:text-green-400 text-4xl"
						>
				...
				>
					...
					>
						{@html StatsRoaster}
						<div
							class="font-bold text-blue-700 dark:text-blue-400 text-4xl"
						>
		...
		<div class="relative mx-auto max-w-6xl">
			...
			>
				...
				>
					...
					<h3
						class="mb-3 font-bold text-slate-800 dark:text-slate-200 text-xl"
					>
						Trace Your Beans
					</h3>
					<p
					...
					>
						Explore coffee origins with detailed region information
				...
				>
					...
					<p
						class="text-slate-600 dark:text-slate-400 leading-relaxed"
					>
						Learn about washed, natural, honey, and experimental
						processing techniques that shape flavor
					</p>
				</div>
				...
				>
					...
					<p
						class="text-slate-600 dark:text-slate-400 leading-relaxed"
					>
						Discover Bourbon, Geisha, SL28, and hundreds of coffee
						varieties with detailed profiles
					</p>
				</div>
			</div>
		</div>
...
>
	<div class="z-10 relative mx-auto px-6 container">
		...
		>
			...
			>
				<span class="bg-green-500 rounded-full w-2 h-2 animate-pulse"
				></span>
			...
			>
				...
				>
					...
					>
						...
						>, literally "tea-drinking shop", are old-school coffee
						houses in Japan which have stood the test of time. They
						offer a selection of (generally) dark roast coffees, and
						many fluffy cakes and other treats. Walking into a
						Kissaten today is about stepping into a world where
						coffee is treated with the same level of respect as a
						fine whisky, which you sip with jazz music playing in
						the background.
					</Accordion.Content>
				</Accordion.Item>
				...
				>
					...
					>
						...
						>. The vast majority of features will remain free for
						everyone, but there may be paid (<em>optional</em>)
						features in the future. There is a cost to collect data
						and to host Kissaten. Our hope is that donations by the
						lovely coffee community cover this over time to make it
						sustainable.
					</Accordion.Content>
				</Accordion.Item>
				...
				>
					...
					>
						<p>
							No! There are plenty of shops and cafés out there
							selling you quality beans. Our goal with Kissaten is
							to highlight the farmers, roasters and other hidden
							heroes working hard behind the scenes. We have no
							intention to profit off their stories and take
							attention away from those that deserve it.
						</p>
						<p>
							Furthermore, Kissaten will increasingly become a
							learning resource powered by data science to help us
							understand coffee better. We hope to be able to
							contribute back to open data projects such as
				...
				>
					<Accordion.Trigger
						class="py-4 font-semibold text-slate-800 dark:text-slate-200 text-lg md:text-xl text-left hover:no-underline"
					>
						I am a roaster/producer. How can I be added? How can I
						ask you to remove my data?
					</Accordion.Trigger>
					<Accordion.Content
						class="pb-6 text-slate-600 dark:text-slate-400 text-base md:text-lg leading-relaxed"
					>
						First of all, hello! We would love to collaborate with
						you. Please open a <a
						...
						>
						to contact us or alternatively email me privately via the
						contact details on
						<a
							href="https://github.com/dldx"
							target="_blank"
				...
				>
					...
					<Accordion.Content
						class="pb-6 text-slate-600 dark:text-slate-400 text-base md:text-lg leading-relaxed"
					>
						Kissaten aims to have coverage of roasters from around
						the world with an emphasis on maintaining a diverse and
						comprehensive dataset. Kissaten also aims to be a
						learning resource to highlight the hidden heroes in the
						coffee supply chain. While we cannot step away from the
						fact that coffee is a consumerist product, we hope that
						Kissaten cracks the door open on the stories and labour
						behind the product.
					</Accordion.Content>
				</Accordion.Item>
				...
				>
					...
					<Accordion.Content
						class="pb-6 text-slate-600 dark:text-slate-400 text-base md:text-lg leading-relaxed"
					>
						We are conscious of the environmental impact of AI.
						Kissaten uses LLMs selectively for complex data
						processing and intelligent search while prioritizing
						efficiency. By using smaller models and minimizing
						redundant compute, we aim to provide a powerful tool
						without a heavy carbon or water footprint, aligning with
						our passion for the natural environments where coffee
						grows. LLMs are primarily used when scraping coffee
						listings from roaster websites to extract structured
						data, and for powering the smart search feature.
					</Accordion.Content>
				</Accordion.Item>
			</Accordion.Root>
		</div>
