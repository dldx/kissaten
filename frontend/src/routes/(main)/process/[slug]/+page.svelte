<script lang="ts">
	...
	function getProcessDescription(category: string): string {
		const descriptions: Record<string, string> = {
			...
			natural: 'In the natural process, whole coffee cherries are dried in the sun before removing the fruit. This extended contact between the bean and cherry creates fruity, wine-like flavours with more body and natural sweetness.',
			anaerobic: 'Anaerobic fermentation occurs in sealed, oxygen-free environments, allowing unique microorganisms to develop distinct flavours. This process produces complex, often funky or wine-like characteristics that can be quite experimental.',
			...
			fermentation: 'Advanced fermentation techniques use controlled environments, specific yeasts, or extended fermentation times to develop unique flavour profiles. These methods often enhance fruity, floral, or complex characteristics.',
			...
			experimental: 'Experimental processes push the boundaries of traditional coffee processing. These include carbonic maceration, thermal shock, yeast inoculation, and other innovative techniques that create unique and often surprising flavour profiles.',
		...
		<div class="gap-6 grid md:grid-cols-2 lg:grid-cols-3">
			...
			<div class="bg-purple-50 p-6 border border-purple-200 rounded-lg process-detail-insight-card-purple">
				<div class="flex items-center mb-4">
					...
					<h3 class="process-detail-insight-title-shadow font-semibold text-purple-900 dark:text-purple-200">Common Tasting Notes</h3>
				</div>
				<div>
