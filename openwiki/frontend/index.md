...
- [Feedback Data Lookup](feedback-data-lookup.md) - How to resolve page_feedback rows from the frontend SQLite database (frontend/local.db) to their source coffee bean JSON files by cross-database join against rw_kissaten.duckdb via DuckDB's sqlite extension.
