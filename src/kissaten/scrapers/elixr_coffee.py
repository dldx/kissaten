...
@register_scraper(
    name="elixr",
    display_name="Elixr Coffee Roaster",
    roaster_name="Elixr Coffee Roaster",
    website="https://elixrcoffee.com",
    description="Philadelphia-based specialty coffee roaster",
    requires_api_key=True,
    currency="USD",
    country="United States",
    status="available",
)
class ElixrCoffeeScraper(BaseScraper):
    """Scraper for Elixr Coffee Roaster (elixrcoffee.com) with AI-powered extraction."""

    def __init__(self, api_key: str | None = None):
        """Initialize Elixr Coffee Roaster scraper.
