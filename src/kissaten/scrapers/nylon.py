"""Nylon Coffee scraper implementation with AI-powered extraction."""
...
@register_scraper(
    name="nylon-coffee",
    display_name="Nylon Coffee",
    roaster_name="Nylon Coffee",
...
class NylonCoffeeScraper(BaseScraper):
    """Scraper for Nylon Coffee with AI-powered extraction."""

    def __init__(self, api_key: str | None = None):
        """Initialize Nylon Coffee scraper.
    ...
    def get_store_urls(self) -> list[str]:
        ...
        """
        return ["https://nylon.coffee/collections/coffee"]
    ...
    async def _extract_product_urls_from_store(self, store_url: str) -> list[str]:
        ...
        all_product_url_el = soup.select('product-card')
        all_product_urls = []
        for el in all_product_url_el:
            if not "Sold out" in el.text:
                all_product_urls.append(f"https://nylon.coffee{el.find('a')['href']}")
