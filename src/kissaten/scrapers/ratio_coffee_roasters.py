"""Ratio Coffee Roasters scraper implementation with AI-powered extraction."""
...
@register_scraper(
    ...
    display_name="Ratio Coffee Roasters",
    roaster_name="Ratio Coffee Roasters",
    website="https://ratiocoffee.at",
    description="Salzburg-based specialty coffee roaster with a focus on sustainable roasting and high-quality beans.",
    requires_api_key=True,
    currency="EUR",
    country="Austria",
    status="available",
)
class RatioCoffeeRoastersScraper(BaseScraper):
    """Scraper for Ratio Coffee Roasters (ratiocoffee.at) with AI-powered extraction."""

    def __init__(self, api_key: str | None = None):
        """Initialize Ratio Coffee Roasters scraper.
        Args:
            api_key: Google API key for Gemini. If None, will try environment variable.
        """
        super().__init__(
            roaster_name="Ratio Coffee Roasters",
            base_url="https://ratiocoffee.at",
    ...
    async def _extract_product_urls_from_store(self, store_url: str) -> list[str]:
        ...
        # Custom selectors for Ratio Coffee Roasters' WooCommerce structure
        custom_selectors = [
