"""Grey Soul Coffee scraper implementation with AI-powered extraction."""
...
@register_scraper(
    ...
    display_name="Grey Soul Coffee",
    roaster_name="Grey Soul Coffee",
    website="https://greysoul.coffee",
    description="Roastery dedicated to sourcing and roasting the best speciality Indian coffee.",
    requires_api_key=True,
    currency="INR",
    country="India",
    status="available",
)
class GreySoulCoffeeScraper(BaseScraper):
    """Scraper for Grey Soul Coffee (greysoul.coffee) with AI-powered extraction."""

    def __init__(self, api_key: str | None = None):
        """Initialize Grey Soul Coffee scraper.
    ...
    async def get_store_urls(self) -> list[str]:
        ...
        """
        return ["https://greysoul.coffee/collections/coffee?filter.v.availability=1"]
