"""Gardelli Coffee scraper implementation with AI-powered extraction."""
...
@register_scraper(
    name="gardelli-coffee",
    display_name="Gardelli Coffee",
    roaster_name="Gardelli Coffee",
...
class GardelliCoffeeScraper(BaseScraper):
    ...
    def __init__(self, api_key: str | None = None):
        ...
        super().__init__(
            roaster_name="Gardelli Coffee",
            base_url="https://gardellicoffee.com",
    ...
    async def _extract_product_urls_from_store(self, store_url: str) -> list[str]:
        ...
        all_product_url_el = soup.select('a.product_image[href*="/coffees/"]')
        ...
        for url in all_product_urls:
            if self.is_coffee_product_url(url, required_path_patterns=["/coffees/"]) and not any(
