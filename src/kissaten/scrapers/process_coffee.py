...
@register_scraper(
    name="process-coffee",
    display_name="Process Coffee",
    roaster_name="Process Coffee",
    website="https://process.coffee",
    description="Specialty coffee roaster based in Belfast, Northern Ireland",
    requires_api_key=True,
    currency="GBP",
    country="United Kingdom",
    status="available",
)
class ProcessCoffeeScraper(BaseScraper):
    """Scraper for Process Coffee with AI-powered extraction."""

    def __init__(self, api_key: str | None = None):
        """Initialize Process Coffee scraper.
    ...
    def get_store_urls(self) -> list[str]:
        ...
        """
        return ["https://process.coffee/collections/coffee"]
    ...
    async def _extract_product_urls_from_store(self, store_url: str) -> list[str]:
        ...
        all_product_url_el = soup.select('div.product-item')
        all_product_urls = []
