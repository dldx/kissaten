...
@register_scraper(
    ...
    display_name="Weekenders Coffee",
    roaster_name="Weekenders Coffee",
    website="https://weekenderscoffee.com",
    description="Specialty coffee roaster based in Kyoto, Japan",
    requires_api_key=True,
    currency="JPY",
    country="Japan",
    status="available",
)
class WeekendersCoffeeScraper(BaseScraper):
    ...
    def __init__(self, api_key: str | None = None):
        ...
        super().__init__(
            roaster_name="Weekenders Coffee",
            base_url="https://weekenderscoffee.com",
    ...
    async def get_store_urls(self) -> list[str]:
        ...
        """
        return [
            "https://www.weekenderscoffee.com/onlineshop/index.html",
        ]
    ...
    async def _extract_product_urls_from_store(self, store_url: str) -> list[str]:
        ...
        for url in all_product_urls:
            if self.is_coffee_product_url(url, required_path_patterns=["beans/"]) and not any(
