"""Crankhouse Coffee scraper.

UK specialty coffee roaster based in Exeter, Devon, offering single origin coffees
with an "omni" roasting style suitable for all brewing methods.
"""
...
@register_scraper(
    ...
    display_name="Crankhouse Coffee",
    roaster_name="Crankhouse Coffee",
    website="https://www.crankhousecoffee.co.uk",
    description="UK specialty coffee roaster from Exeter with omni roasting style "
...
class CrankhouseCoffeeScraper(BaseScraper):
    """Scraper for Crankhouse Coffee."""
    ...
    def __init__(self, api_key: str | None = None):
        ...
        super().__init__(
            roaster_name="Crankhouse Coffee",
            base_url="https://www.crankhousecoffee.co.uk",
    ...
    def get_store_urls(self) -> list[str]:
        ...
        """
        return [
            "https://www.crankhousecoffee.co.uk/collections/our-coffees",
        ]

    async def scrape(self, force_full_update: bool = False) -> list[CoffeeBean]:
        """Scrape coffee beans from Crankhouse Coffee with efficient stock updates.
        ...
        # If AI extractor is not available, fallback to traditional scraping
        if not self.ai_extractor:
            logger.warning("AI extractor not available - falling back to traditional scraping")
