...
@register_scraper(
    ...
    display_name="H&S Coffee Roasters",
    roaster_name="H&S Coffee Roasters",
    website="https://hscoffeeroasters.com",
    description="Speciality coffee roaster based in Laramie, Wyoming, United States.",
    requires_api_key=True,
    currency="USD",
    country="United States",
    status="available",
)
class HS_CoffeeRoastersScraper(BaseScraper):
    """Scraper for H&S Coffee Roasters (hscoffeeroasters.com) with AI-powered extraction."""

    def __init__(self, api_key: str | None = None):
        """Initialize H&S Coffee Roasters scraper.
        ...
        super().__init__(
            roaster_name="H&S Coffee Roasters",
            base_url="https://hscoffeeroasters.com",
    ...
    async def get_store_urls(self) -> list[str]:
        ...
        """
        return ["https://hscoffeeroasters.com/collections/coffee?filter.v.availability=1"]
    ...
    async def fetch_page(self, *args, **kwargs) -> BeautifulSoup | Tag | None:
        ...
        try:
            ...
            product_el = soup.select("div.product-page")
            if len(product_el) == 1:
                return product_el[0]
    ...
    async def _extract_product_urls_from_store(self, store_url: str) -> list[str]:
        ...
        # Get listing section
        listing_section = soup.select("div.collection__products")
        ...
        product_urls_el = listing_section[0].select('a[href*="/products/"]')
