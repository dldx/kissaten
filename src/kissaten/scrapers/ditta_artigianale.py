"""Ditta Artigianale scraper implementation with AI-powered extraction."""
...
@register_scraper(
    ...
    display_name="Ditta Artigianale",
    roaster_name="Ditta Artigianale",
    website="https://dittaartigianale.com",
    description="Specialty coffee roaster based in Italy",
    requires_api_key=True,
    currency="EUR",
    country="Italy",
    status="available",
)
class DittaArtigianaleScraper(BaseScraper):
    ...
    def __init__(self, api_key: str | None = None):
        ...
        super().__init__(
            roaster_name="Ditta Artigianale",
            base_url="https://dittaartigianale.com",
    ...
    def get_store_urls(self) -> list[str]:
        ...
        """
        return [
            "https://dittaartigianale.com/en/collections/monorigini-specialty-coffee?filter.v.availability=1&page=1",
            "https://dittaartigianale.com/en/collections/monorigini-specialty-coffee?filter.v.availability=1&page=2",
            "https://dittaartigianale.com/en/collections/decaf?filter.v.availability=1&page=1",
            "https://dittaartigianale.com/en/collections/le-nostre-miscele?filter.v.availability=1&page=1",
            "https://dittaartigianale.com/en/collections/special-edition?filter.v.availability=1&page=1",
        ]
