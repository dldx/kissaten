"""Bean Smitten scraper implementation with AI-powered extraction (Wix storefront)."""
...
@register_scraper(
    name="bean-smitten",
    display_name="Bean Smitten",
    roaster_name="Bean Smitten",
    website="https://www.beansmitten.co.uk",
    description="Specialty coffee roaster based in Flimwell, Kent/East Sussex border "
    "(High Weald, United Kingdom), roasting blends and single origins for home and wholesale",
    requires_api_key=True,
    currency="GBP",
    country="United Kingdom",
    status="available",
)
class BeanSmittenScraper(BaseScraper):
    """Scraper for Bean Smitten (beansmitten.co.uk) with AI-powered extraction."""

    def __init__(self, api_key: str | None = None):
        """Initialize Bean Smitten scraper.
        ...
        super().__init__(
            roaster_name="Bean Smitten",
            base_url="https://www.beansmitten.co.uk",
    ...
    async def get_store_urls(self) -> list[str]:
        ...
        Returns:
            List containing the coffee beans listing URL.
        """
        return ["https://www.beansmitten.co.uk/buy-coffee-beans"]
